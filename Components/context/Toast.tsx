...
function Toast() {
  ...
  return (
    <div
      className={`fixed z-[1000] -top-10 transition-all duration-700 mx-auto lg:left-[35vw] md:left-[30vw] left-[5vw] backdrop-blur-xl border md:w-[400px] w-[90vw] rounded-xl px-3.5 py-1.5 text-lg ${
        ...
        state.theme.theme === "LIGHT"
          ...
          : "border-stone-700 shadow-2xl shadow-stone-900"
      }`}
    >
